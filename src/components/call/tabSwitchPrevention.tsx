...
const useTabSwitchPrevention = () => {
  ...
  const getSeverityText = () => {
    const level = getSeverityLevel();
    switch (level) {
      case "low": return "Minor Violation";
      case "medium": return "Moderate Violation";
      case "high": return "Serious Violation";
        ...
        <AlertDialogHeader className="space-y-4">
            ...
            `}>
              ...
              {isRepeatedViolation && (
                <div className="absolute -top-1 -right-1 w-6 h-6 bg-red-500 rounded-full flex items-center justify-center border-2 border-white">
                  <span className="text-white text-xs font-bold">{tabSwitchCount}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="text-center space-y-2">
            <AlertDialogTitle className="text-2xl font-bold text-gray-900">
              {isFirstViolation ? "Tab Switch Detected" : "Multiple Tab Switches Detected"}
            </AlertDialogTitle>
            
            <div className="flex items-center justify-center gap-2">
              <Badge className={`bg-gradient-to-r ${getSeverityColor()} text-white border-0`}>
          ...
          <AlertDialogDescription className="text-center space-y-3">
            <div className="p-4 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-red-100">
              ...
              <p className="text-gray-600 text-sm">
                This behavior is being monitored and may impact your interview evaluation.
              </p>
            </div>
          </AlertDialogDescription>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-3 bg-gray-50 rounded-xl text-center">
              <div className="flex items-center justify-center mb-1">
                ...
                <span className="text-xs font-medium text-gray-600">Total Switches</span>
              </div>
              <p className="text-xl font-bold text-gray-900">{tabSwitchCount}</p>
            </div>
            ...
            {lastSwitchTime && (
              <div className="p-3 bg-gray-50 rounded-xl text-center">
                <div className="flex items-center justify-center mb-1">
                  ...
                  <span className="text-xs font-medium text-gray-600">Last Switch</span>
                </div>
          ...
          <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                <h4 className="font-semibold text-blue-900">Interview Guidelines</h4>
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  {isRepeatedViolation && (
                    <li className="text-red-700 font-medium">• Further violations may result in interview termination</li>
                  )}
                </ul>
              </div>
            </div>
          ...
          {severityLevel === "high" && (
            <div className="p-4 bg-gradient-to-r from-red-50 to-red-100 rounded-xl border-2 border-red-200">
              ...
              <p className="text-sm text-red-800">
                You have exceeded the recommended number of tab switches. 
                Please remain focused on the interview to avoid potential disqualification.
              </p>
            </div>
          )}
        </div>
