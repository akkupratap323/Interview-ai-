                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Listen to {interviewer.name}'s voice
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 leading-relaxed text-justify">
                  {interviewer?.description ||
                    "This AI interviewer brings advanced conversational abilities and deep industry expertise to provide comprehensive candidate evaluation."}
                </p>
              </CardContent>
            </Card>
          ...
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Understanding {interviewer?.name}'s interview approach and style
              </p>
            </div>
                  ...
                  <div key={index} className="group">
                    <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1">
                      <CardContent className="p-6">
                        <div className="flex items-center gap-4 mb-4">
                          <div
                            className={`w-12 h-12 ${trait.bgColor} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform`}
                          >
                            <IconComponent
                              className={`w-6 h-6 ${trait.color}`}
                            />
                          </div>
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-3">
                              <div
                                className={`h-3 rounded-full bg-gradient-to-r transition-all duration-1000 ${
                                  trait.color.includes("pink")
                                    ? "from-pink-400 to-pink-600"
                                    : trait.color.includes("blue")
                                      ? "from-blue-400 to-blue-600"
                                      : trait.color.includes("purple")
