    ...
    return (
      <input
        ...
        className={cn(
          ...
          // Variant styles
          {
            "border-input focus-visible:ring-ring hover:border-gray-300": variant === "default",
            "border-gray-200 bg-gray-50/50 focus-visible:ring-indigo-500 focus-visible:border-indigo-300": variant === "search",
            "border-transparent bg-transparent focus-visible:ring-indigo-500": variant === "ghost",
          },
